...
from utils.proto.account.auth_pb2 import AccountRegistrationRequest, AccountResponse
...
def post_account_registration(
    ...
    timestamp_proto = Timestamp().FromDatetime(request.date_of_birth)
